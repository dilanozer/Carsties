    ...
    (finishedAuction: AuctionFinished) => {
      ...
      return toast.promise(
        auction,
        {
          ...
          error: (err) => {
            console.error("Error in auction finished:", err); // Hata loglama
            return "Auction finished with error";
          },
        },
  ...
  useEffect(() => {
    if (!connection.current) {
      connection.current = new HubConnectionBuilder()
        ...
        .catch((err) => console.error("Error while connecting to the hub:", err));      
    }
